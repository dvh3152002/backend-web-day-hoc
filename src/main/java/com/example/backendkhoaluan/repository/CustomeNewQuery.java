...
public class CustomeNewQuery {
    private CustomeNewQuery() {
    }

    @Data
    @NoArgsConstructor
    public static class NewFilterParam {
    ...
    public static Specification<News> getFilterNew(NewFilterParam param) {
        return (((root, query, criteriaBuilder) -> {
            ...
            if (param.keywords != null) {
                predicates.add(CriteriaBuilderUtils.createPredicateForSearchInsensitive(root, criteriaBuilder,
                        param.keywords, "title","description"));
            }
